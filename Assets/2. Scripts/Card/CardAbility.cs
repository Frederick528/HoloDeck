...
public class CardAbility
{
    ...
    async UniTask ContinuousSinglettackAB(Card card, float delay = 0.3f)
    {
        //Enemy enemy = EnemyManager.Instance.targetEnemy;
    ...
    async UniTask ContinuousMultiAttackAB(Card card, float delay = 0.3f)
    {
    ...
    async UniTask ConfirmedDiscardAB()
    {
        ...
        ButtonManager.Instance.DiscardCancelBtnInvert(false);
        ...
        ButtonManager.Instance.DiscardCancelBtnInvert(true);
